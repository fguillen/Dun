...
11. **API endpoint reference** ([api-endpoints.md](api-endpoints.md)) — every endpoint, cross-linked back to the phase that introduced it.

Phases 9–14 are not yet shipped; their slots in this doc set will fill in as the work lands.
