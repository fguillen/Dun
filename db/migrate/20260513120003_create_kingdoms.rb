class CreateKingdoms < ActiveRecord::Migration[8.1]
  ...
  def change
    create_table :kingdoms do |t|
      ...
      t.references :home_region, foreign_key: { to_table: :regions }
    ...
    add_reference :worlds, :winner_kingdom, foreign_key: { to_table: :kingdoms } unless column_exists?(:worlds, :winner_kingdom_id)
  end
end
