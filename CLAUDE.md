...
- **Implementation roadmap**: [TODO.md](TODO.md). Phases 1 (Identity, Auth, Server Membership), 2 (World Lifecycle & Map Generation), 3 (Resources, Buildings & Build Queue), and 4 (Tick Engine & Time Model) are complete; Phase 5 (Military: Units, Training, March) is next.
