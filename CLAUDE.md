...
- **Implementation roadmap**: [TODO.md](TODO.md). Phases 1 (Identity, Auth, Server Membership), 2 (World Lifecycle & Map Generation), and 3 (Resources, Buildings & Build Queue) are complete; Phase 4 (Tick Engine & Time Model) is next.
