...
- **Implementation roadmap**: [TODO.md](TODO.md). Phases 1 (Identity, Auth, Server Membership), 2 (World Lifecycle & Map Generation), 3 (Resources, Buildings & Build Queue), 4 (Tick Engine & Time Model), 5 (Military: Units, Training, March), 6 (Combat Resolution & Battle Reports), 7 (Nodes, Capture, Ruins), 8 (Trade, Caravans & Ledger), and 9 (Wonder Mechanics) are complete; Phase 10 (Round End, Archive & Persistent Profiles) is next.
